set_global_assignment -name ROOT "|mips_sys" -remove 
set_global_assignment -name FAMILY -remove 
set_global_assignment -section_id clk_setting -name DUTY_CYCLE "50.00" -remove 
set_instance_assignment -entity mips_sys -to clk -name GLOBAL_SIGNAL ON -remove 
set_instance_assignment -entity mips_sys -to clk -name USE_CLOCK_SETTINGS clk_setting -remove 
set_global_assignment -section_id clk_setting -name FMAX_REQUIREMENT "50.0MHZ" -remove 
