...
set_global_assignment -name ROOT "|r5_reg_cls"
set_global_assignment -name FAMILY "CYCLONE"
set_global_assignment -name DEVICE "EP1C3T100C6"
set_global_assignment -section_id r5_reg_cls -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_instance_assignment -entity r5_reg_cls -to clk -name GLOBAL_SIGNAL ON
set_instance_assignment -entity r5_reg_cls -to clk -name USE_CLOCK_SETTINGS clk_setting 
